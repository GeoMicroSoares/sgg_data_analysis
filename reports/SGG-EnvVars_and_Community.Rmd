...
And does SO4 coincide 'more or less' negatively correlate with DO just to make sure?
...
adonis(ps_cap_r_jsd ~ Site.ID + Temp.C + Month + EC.uS.cm + DO..sat + K.µg.ml + Na.µg.ml + Cl..µg.ml + SO4..µg.ml + X6.Li.ng.ml + X7.Li.ng.ml + X7.Li..He..ng.ml + X11.B.ng.ml + X45.Sc.ng.ml + X55.Mn.ng.ml + X59.Co.ng.ml + X60.Ni.ng.ml + X69.Ga.ng.ml + X75.As..He..ng.ml + X78.Se.ng.ml + X85.Rb.ng.ml + X88.Sr.ng.ml + X89.Y.ng.ml + X125.Te.ng.ml + X133.Cs.ng.ml + X135.Ba.ng.ml + X139.La.ng.ml + X146.Nd.ng.ml + X153.Eu.ng.ml + X166.Er.ng.ml + X175.Lu.ng.ml + X238.U.ng.ml, 
...
arrowmat_CAP_norm<-arrowmat_CAP_norm[!grepl("Site.name", rownames(arrowmat_CAP_norm)),]
arrowmat_CAP_norm<-arrowmat_CAP_norm[!grepl("Month_cat", rownames(arrowmat_CAP_norm)),]
arrowdf_CAP_norm <- data.frame(labels = rownames(arrowmat_CAP_norm), arrowmat_CAP_norm)
rownames(arrowdf_CAP_norm) <- c("Site ID","Temperature","EC","DO","K","Na","Cl","SO4","6_Li","7_Li","7_Li_He",
                                               "B","Sc","Mn","Co","Ni","Ga","As","Sr","Y","Cs","La","U")
arrowdf_CAP_norm$labels <- c("Site ID","Temperature","EC","DO","K","Na","Cl","SO4","6_Li","7_Li","7_Li_He",
                                               "B","Sc","Mn","Co","Ni","Ga","As","Sr","Y","Cs","La","U")
arrow_map_CAP_norm <- aes(xend = CAP1, yend = CAP2,
                     x = 0, y = 0,
                     shape = NULL, color = NULL,
                     label = labels)
label_map_CAP_norm <- aes(x = 1.1 * CAP1, y = 1.1 * CAP2,
                     shape = NULL, color = NULL,
                     label = labels)
...
arrowmat_CAP_norm_13<-arrowmat_CAP_norm_13[!grepl("Site.name", rownames(arrowmat_CAP_norm_13)),]
arrowmat_CAP_norm_13<-arrowmat_CAP_norm_13[!grepl("Month_cat", rownames(arrowmat_CAP_norm_13)),]
arrowdf_CAP_norm_13 <- data.frame(labels = rownames(arrowmat_CAP_norm_13), arrowmat_CAP_norm_13)
rownames(arrowdf_CAP_norm_13) <- c("Site ID","Temperature","EC","DO","K","Na","Cl","SO4","6_Li","7_Li","7_Li_He",
                                               "B","Sc","Mn","Co","Ni","Ga","As","Sr","Y","Cs","La","U")
arrowdf_CAP_norm_13$labels <- c("Site ID","Temperature","EC","DO","K","Na","Cl","SO4","6_Li","7_Li","7_Li_He",
                                               "B","Sc","Mn","Co","Ni","Ga","As","Sr","Y","Cs","La","U")
arrow_map_CAP_norm_13 <- aes(xend = CAP1, yend = CAP3,
                        x = 0, y = 0,
                        shape = NULL, color = NULL,
                        label = labels)
label_map_CAP_norm_13 <- aes(x = 1.1 * CAP1, y = 1.1 * CAP3,
                        shape = NULL, color = NULL,
                        label = labels)
...
arrowmat_CAP_norm_taxa_april<-arrowmat_CAP_norm_taxa_april[!grepl("Site.name", rownames(arrowmat_CAP_norm_taxa_april)),]
arrowmat_CAP_norm_taxa_april<-arrowmat_CAP_norm_taxa_april[!grepl("Month_cat", rownames(arrowmat_CAP_norm_taxa_april)),]
rownames(arrowmat_CAP_norm_taxa_april) <- c("Site ID","Temperature","EC","DO","K","Na","Cl","SO4","6_Li","7_Li","7_Li_He",
                                               "B","Sc","Mn","Co","Ni","Ga","As","Sr","Y","Cs","La","U")
...
final_CAP_norm_april_taxa_sig_plot_a12 = ggplot(data=CAP_norm_april_taxa_sig_plot_a12,
  ...
  geom_text(mapping = label_map_CAP_norm_taxa_april, size = 5, fontface="bold",
            data = arrowdf_CAP_norm_taxa_april, show.legend = FALSE, 
            check_overlap = TRUE) +
  scale_color_manual(values = colorRampPalette(brewer.pal(12, "Paired"))(25),
                     na.value = "black") +
...
arrowmat_CAP_norm_taxa_august<-arrowmat_CAP_norm_taxa_august[!grepl("Site.name", rownames(arrowmat_CAP_norm_taxa_august)),]
arrowmat_CAP_norm_taxa_august<-arrowmat_CAP_norm_taxa_august[!grepl("Month_cat", rownames(arrowmat_CAP_norm_taxa_august)),]
rownames(arrowmat_CAP_norm_taxa_august) <- c("Site ID","Temperature","EC","DO","K","Na","Cl","SO4","6_Li","7_Li","7_Li_He",
                                               "B","Sc","Mn","Co","Ni","Ga","As","Sr","Y","Cs","La","U")
...
final_CAP_norm_august_taxa_sig_plot_a12 = ggplot(data=CAP_norm_august_taxa_sig_plot_a12,
  ...
  geom_text(mapping = label_map_CAP_norm_taxa_august, size = 5, fontface="bold",
            data = arrowdf_CAP_norm_taxa_august, show.legend = FALSE, 
            check_overlap = TRUE) +
...
arrowmat_CAP_norm_taxa_december<-arrowmat_CAP_norm_taxa_december[!grepl("Site.name", rownames(arrowmat_CAP_norm_taxa_december)),]
arrowmat_CAP_norm_taxa_december<-arrowmat_CAP_norm_taxa_december[!grepl("Month_cat", rownames(arrowmat_CAP_norm_taxa_december)),]
rownames(arrowmat_CAP_norm_taxa_december) <- c("Site ID","Temperature","EC","DO","K","Na","Cl","SO4","6_Li","7_Li","7_Li_He",
                                               "B","Sc","Mn","Co","Ni","Ga","As","Sr","Y","Cs","La","U")
...
final_CAP_norm_december_taxa_sig_plot_a12 = ggplot(data=CAP_norm_december_taxa_sig_plot_a12,
  ...
  geom_text(mapping = label_map_CAP_norm_taxa_december, size = 5, fontface="bold",
            data = arrowdf_CAP_norm_taxa_december, show.legend = FALSE, 
            check_overlap = TRUE) +
  scale_color_manual(values = colorRampPalette(brewer.pal(12, "Paired"))(27),
                     na.value = "black") +
