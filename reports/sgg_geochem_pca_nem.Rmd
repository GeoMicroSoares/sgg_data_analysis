...
<!-- Does it make a difference to have the data in meqs? -->

<!-- ```{r echo=FALSE, fig.height=8, fig.width=10, message=FALSE, warning=FALSE} -->
<!-- library(ggforce) -->
<!-- pca_table_meq=read.csv("E://PhD//SGG//SGG_hydrogeochem//SGG_hydro_and_geochemistry_v3_tidy_meq.csv", header=TRUE) -->

<!-- # pca_table_meq_noNA = pca_table_meq[ , colSums(is.na(pca_table_meq)) == 0] -->

<!-- pca_table_meq$NaCa_ratio = (pca_table_meq$Na/(pca_table_meq$Na + pca_table_meq$Ca)) -->

<!-- ggplot(pca_table_meq, aes(Cl, NaCa_ratio, size=Temp.C, -->
<!--                       color=Site.name, shape=Month)) + -->
<!--   geom_point(alpha=0.8) + -->
